import { c as createComponent, b as addAttribute, a as renderTemplate, s as spreadAttributes, u as unescapeHTML, B as defineScriptVars, d as createAstro, r as renderComponent, F as Fragment, e as renderScript, C as renderHead, f as renderSlot } from './astro/server_D76GWIxZ.mjs';
import 'kleur/colors';
/* empty css                                 */
import { b as getAsset, U as UI, c as getCanonical, I as I18N, S as SITE, M as METADATA } from './permalinks_BPyQFblM.mjs';
import 'clsx';
import merge from 'lodash.merge';
import { escape } from 'html-escaper';
import { b as getImage } from './_astro_assets_BzVGQ_kU.mjs';
...
}, "D:/Projects/Three_Holy_Hierarchs/src/components/common/CommonMeta.astro", void 0);
...
const appleTouchIcon = new Proxy({"src":"/_astro/apple-touch-icon.DHIlG7dp.png","width":180,"height":180,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "D:/Projects/Three_Holy_Hierarchs/src/assets/favicons/apple-touch-icon.png";
							}
...
}, "D:/Projects/Three_Holy_Hierarchs/src/components/Favicons.astro", void 0);

const $$CustomStyles = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<!-- Підключення Playfair Display з Google Fonts --><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Playfair+Display:wght@400;500;600;700&subset=cyrillic,cyrillic-ext&display=swap" rel="stylesheet"><style>
  :root {
    /* Шрифти */
    --aw-font-sans: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
    --aw-font-serif: 'Playfair Display', Georgia, serif;
    --aw-font-heading: 'Playfair Display', Georgia, serif;

    /* Православна кольорова схема */
    /* Золотий - символ божественного світла */
    --aw-color-primary: rgb(234 179 8); /* yellow-500 */
    --aw-color-secondary: rgb(30 58 95); /* темно-синій - небесний */
    --aw-color-accent: rgb(139 0 0); /* темно-червоний - літургійний */

    /* Кольори тексту */
    --aw-color-text-heading: rgb(17 24 39); /* slate-900 */
    --aw-color-text-default: rgb(31 41 55); /* gray-800 */
    --aw-color-text-muted: rgb(107 114 128); /* gray-500 */
    --aw-color-bg-page: rgb(255 255 255);

    --aw-color-bg-page-dark: rgb(15 23 42); /* slate-900 */

    ::selection {
      background-color: rgb(234 179 8 / 30%); /* золотистий */
      color: rgb(17 24 39);
    }
  }

  .dark {
    /* Шрифти для темної теми */
    --aw-font-sans: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
    --aw-font-serif: 'Playfair Display', Georgia, serif;
    --aw-font-heading: 'Playfair Display', Georgia, serif;

    /* Адаптована кольорова схема для темної теми */
    --aw-color-primary: rgb(250 204 21); /* yellow-400 - світліший золотий */
    --aw-color-secondary: rgb(59 130 246); /* blue-500 - світліший синій */
    --aw-color-accent: rgb(220 38 38); /* red-600 - світліший червоний */

    /* Кольори тексту для темної теми */
    --aw-color-text-heading: rgb(248 250 252); /* slate-50 */
    --aw-color-text-default: rgb(226 232 240); /* slate-200 */
    --aw-color-text-muted: rgb(148 163 184); /* slate-400 */
    --aw-color-bg-page: rgb(15 23 42); /* slate-900 */

    ::selection {
      background-color: rgb(250 204 21 / 30%); /* золотистий */
      color: rgb(248 250 252);
    }
  }

  /* Додаткові стилі для православної естетики */
  body {
...
}, "D:/Projects/Three_Holy_Hierarchs/src/components/CustomStyles.astro", void 0);
...
}, "D:/Projects/Three_Holy_Hierarchs/src/components/common/ApplyColorMode.astro", void 0);
...
}, "D:/Projects/Three_Holy_Hierarchs/node_modules/@astrolib/seo/src/AstroSeo.astro", void 0);
...
const load = async function() {
  let images = void 0;
  try {
    images = /* #__PURE__ */ Object.assign({"/src/assets/images/default.png": () => import('./default_DM2_lmtf.mjs')});
  } catch (error) {
  }
  return images;
};
...
}, "D:/Projects/Three_Holy_Hierarchs/src/components/common/Metadata.astro", void 0);

const $$SiteVerification = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${SITE.googleSiteVerificationId}`;
}, "D:/Projects/Three_Holy_Hierarchs/src/components/common/SiteVerification.astro", void 0);
...
}, "D:/Projects/Three_Holy_Hierarchs/node_modules/@astrolib/analytics/src/GoogleAnalytics.astro", void 0);

const $$Analytics = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${null}`;
}, "D:/Projects/Three_Holy_Hierarchs/src/components/common/Analytics.astro", void 0);
...
}, "D:/Projects/Three_Holy_Hierarchs/src/components/common/BasicScripts.astro", void 0);
...
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "D:/Projects/Three_Holy_Hierarchs/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "D:/Projects/Three_Holy_Hierarchs/node_modules/astro/components/ClientRouter.astro", void 0);
...
}, "D:/Projects/Three_Holy_Hierarchs/src/layouts/Layout.astro", void 0);
