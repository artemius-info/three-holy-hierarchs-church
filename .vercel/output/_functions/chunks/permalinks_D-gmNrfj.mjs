...
const SITE = {"name":"Храм на честь Трьох святителів на Подолі","site":"https://three-holy-hierarchs-church.vercel.app","base":"/","trailingSlash":false,"googleSiteVerificationId":null};
                    const I18N = {"language":"uk","textDirection":"ltr"};
                    const METADATA = {"title":{"default":"Храм на честь Трьох святителів на Подолі","template":"%s | Храм Трьох святителів"},"description":"Офіційний сайт православного храму на честь Трьох святителів на Подолі. Розклад богослужінь, новини приходу, проповіді.","openGraph":{"type":"website","site_name":"Храм Трьох святителів","images":[{"url":"~/assets/images/default.png","width":1200,"height":628}]},"twitter":{"handle":"","site":"","cardType":"summary_large_image"}};
                    const APP_BLOG = {"postsPerPage":9,"post":{"permalink":"/news/%slug%","robots":{"index":true,"follow":true}},"list":{"pathname":"news","robots":{"follow":true}},"category":{"pathname":"news/category","robots":{"index":true,"follow":true}},"tag":{"pathname":"news/tag","robots":{"index":true,"follow":true}}};
